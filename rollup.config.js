...
function baseConfig() {
  return {
    moduleName: 'React-CoreUI-Component',
    entry: 'src/index.js',
    plugins: [
      nodeResolve(),
      commonjs({
...
libConfig.targets = [
  { dest: 'dist/react-coreui-component.cjs.js', format: 'cjs' },
  { dest: 'dist/react-coreui-component.es.js', format: 'es' },
];
...
/*
  ...
  1) `react-coreui-component.min.js`
  ...
  2) `react-coreui-component.full.min.js`
...
umdFullConfig.targets = [
  { dest: 'dist/react-coreui-component.full.js', format: 'umd' },
];
...
umdFullConfigMin.targets = [
  { dest: 'dist/react-coreui-component.full.min.js', format: 'umd' },
];
...
umdConfig.targets = [
  { dest: 'dist/react-coreui-component.js', format: 'umd' },
];
...
umdConfigMin.targets = [
  { dest: 'dist/react-coreui-component.min.js', format: 'umd' },
];
